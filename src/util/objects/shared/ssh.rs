...
impl CommandWrapper {
    pub fn append_ssh_command(&mut self, ssh_config: &SshConfig, module_paths: &ModulePaths, dry_run: bool, use_docker: bool, has_previous: bool) -> Result<&mut CommandWrapper, String> {
